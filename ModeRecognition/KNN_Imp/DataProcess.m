...
xlswrite("WeightedEulerDistance.xlsx",EDxlsx);
% 数据可视化
figure
[m,~] = size(EDxlsx);
R = 0:1/n:1;
...
title("KNN-Weighted Euler Distance");
xlabel("训练集大小");
ylabel("准确度%");
legend(leg,"location","NorthWest");
set(gca,'fontsize',20);

% %% WeightedManhattanDistance KNN
...
% xlswrite("WeightedManhattanDistance.xlsx",MDxlsx);
% % 数据可视化
% figure
% [m,~] = size(MDxlsx);
% R = 0:1/n:1;
...
%     hold on
% end
% title("KNN-Weighted Manhattan Distance");
% xlabel("训练集大小");
% ylabel("准确度%");
% legend(leg,"location","NorthWest");
% set(gca,'fontsize',20);
